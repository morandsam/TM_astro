...
\begin{figure}[H]
	...
	\caption[Valeurs de $\theta \left( \xi\right) $ en fonction de l'indice $n$ choisi\newline
	\url{https://www.mathworks.com/matlabcentral/mlc-downloads/downloads/submissions/23972/versions/22/previews/chebfun/examples/ode/html/LaneEmden.html}]{Valeurs de $\theta \left( \xi\right) $ en fonction de l'indice $n$ choisi}
	\label{Fig. 7.2}
\end{figure}\bigskip


\section{Masse de Chandrasekhar}\label{7.2}
