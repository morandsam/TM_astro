...
\subsection{Supernovas thermonucléaires}
...
\begin{equation} \ce{n -> \ce{p+} + \ce{e-} + $\overline{\nu}$_{e}} \end{equation}\smallskip
 ...
 \vfill
 \footnotetext[1]{Il existe aussi un processus s (slowly) de capture de neutrons qui prend lieu dans des étoiles AGB (§2.2.2) déjà enrichies par une supernova précédente.}
