...
\subsection{Le diagramme de Hertzsprung-Russell}
...
\begin{figure}[H]\vspace{1cm}
	\centering
	\includegraphics[scale=0.32]{images/compo_sp}
...
\begin{figure}[H]\vspace{1cm}
	\centering
	\includegraphics[scale=0.50]{images/compo_sp_gr}
	\caption{Comparaison entre les différentes premières phases de fusion d'une étoile (pas à l'échelle)}
\end{figure}
