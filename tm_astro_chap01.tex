...
Avec P étant la force de pression radiative, la deuxième loi de Newton nous permet
...
\footnotetext[5]{Cette démonstration sera présentée plus en détails dans les annexes.}
...
\vfill
\footnotetext[6]{Cette équation a été nommée en l'honneur des physiciens Jonathan Lane et Robert Emden pour leur travail sur celle-ci.}
\footnotetext[7]{La masse et le rayon ne sont pas les seuls observables pouvant être déterminées par ce modèle, la pression et la densité peuvent l'être aussi, mais nous n'allons pas les traiter ici.}
\footnotetext[8]{Nous pouvons interpréter l'Eq. \ref{Eq. 1.19} comme une équation différentielle ou comme une fonction de $\theta$ par rapport à $\xi$; le premier zéro de la fonction correspond à la première valeur pour laquelle l'équation est résolue.}
